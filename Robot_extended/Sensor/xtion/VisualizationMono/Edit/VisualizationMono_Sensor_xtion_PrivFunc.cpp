...
bool DECOFUNC(processMonoDrainData)(void * paramsPtr, void * varsPtr, QVector<void *> drainParams, QVector<void *> drainData)
{
	...
	*/
    ...
    // 在深度图像中显示出各个骨骼点
        ...
        if (point.x > 0 && point.y > 0 && point.x < cvColorImg2Show.cols && point.y < cvColorImg2Show.rows)
            cv::circle(cvColorImg2Show, point, 6, cv::Scalar(255,0,0), -1);
    }

    // 画出连线
    cv::line(cvColorImg2Show, draindata.front()->jointPos2D[0], draindata.front()->jointPos2D[1], cv::Scalar(0,0,128), 2);
    cv::line(cvColorImg2Show, draindata.front()->jointPos2D[1], draindata.front()->jointPos2D[2], cv::Scalar(0,0,128), 2);
    cv::line(cvColorImg2Show, draindata.front()->jointPos2D[2], draindata.front()->jointPos2D[4], cv::Scalar(0,0,128), 2);
    cv::line(cvColorImg2Show, draindata.front()->jointPos2D[4], draindata.front()->jointPos2D[6], cv::Scalar(0,0,128), 2);
    cv::line(cvColorImg2Show, draindata.front()->jointPos2D[1], draindata.front()->jointPos2D[3], cv::Scalar(0,0,128), 2);
    cv::line(cvColorImg2Show, draindata.front()->jointPos2D[3], draindata.front()->jointPos2D[5], cv::Scalar(0,0,128), 2);
    cv::line(cvColorImg2Show, draindata.front()->jointPos2D[5], draindata.front()->jointPos2D[7], cv::Scalar(0,0,128), 2);
    cv::line(cvColorImg2Show, draindata.front()->jointPos2D[2], draindata.front()->jointPos2D[8], cv::Scalar(0,0,128), 2);
    cv::line(cvColorImg2Show, draindata.front()->jointPos2D[3], draindata.front()->jointPos2D[8], cv::Scalar(0,0,128), 2);
    cv::line(cvColorImg2Show, draindata.front()->jointPos2D[8], draindata.front()->jointPos2D[9], cv::Scalar(0,0,128), 2);
    cv::line(cvColorImg2Show, draindata.front()->jointPos2D[9], draindata.front()->jointPos2D[11], cv::Scalar(0,0,128), 2);
    cv::line(cvColorImg2Show, draindata.front()->jointPos2D[11], draindata.front()->jointPos2D[13], cv::Scalar(0,0,128), 2);
    cv::line(cvColorImg2Show, draindata.front()->jointPos2D[8], draindata.front()->jointPos2D[10], cv::Scalar(0,0,128), 2);
    cv::line(cvColorImg2Show, draindata.front()->jointPos2D[10], draindata.front()->jointPos2D[12], cv::Scalar(0,0,128), 2);
    cv::line(cvColorImg2Show, draindata.front()->jointPos2D[12], draindata.front()->jointPos2D[14], cv::Scalar(0,0,128), 2);
